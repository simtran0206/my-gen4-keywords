...
try {
	Windows.verifyElementNotPresent(findWindowsObject('Notepad/TitleBar About Notepad'), 10)
	assert false
} catch(Exception) {
...
Windows.verifyElementNotPresent(findWindowsObject('Notepad/TitleBar About Notepad'), 0)
