...
List<String> links = WebUI.getAllLinksOnCurrentPage(true, null)

def excludedChromeExtensionLink=[];
for (int i=0;i<links.size();i++){
	if (links[i].indexOf('-extension'))
		{
			excludedChromeExtensionLink.add(links[i])
		}
}
