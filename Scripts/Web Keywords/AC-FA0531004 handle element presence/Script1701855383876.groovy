...
WebUI.waitForElementPresent(helloWorldDiv, 30)

//There is a bug : https://katalon.atlassian.net/browse/STUDIO-3123 : verifyElementPresent work with incorrect timeout
WebUI.verifyElementPresent(helloWorldDiv, 30)
